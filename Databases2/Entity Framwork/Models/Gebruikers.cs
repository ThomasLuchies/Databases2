...
namespace Entity_Framwork.Models
{
	public class Gebruikers
	{
		...
		public Gebruikers(string emailadres, string wachtwoord, bool actief, bool geblokkeerd, DateTime geblokkeerd_tot, short foutieve_inlogpogingen, string reset_token)
		{
